...
public class KProverTest {
    ...
    public Object[][] completenessTestsProvider() throws Reader.ParsingException {
        ...
        List<Problem > tests = ProblemReader.readFrom(Simulator.class.getResourceAsStream("K-completness-tests.clj"));
    ...
    public Object[][] soundnessTestsProvider() throws Reader.ParsingException {
        ...
        List<Problem >tests = ProblemReader.readFrom(Simulator.class.getResourceAsStream("K-soundness-tests.clj"));
        Object[][] cases =  new Object[tests.size()][2];
